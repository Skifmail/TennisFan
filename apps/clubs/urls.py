...
urlpatterns = [
    ...
    path(
        "my/",
        RedirectView.as_view(pattern_name="clubs:my_clubs", permanent=False),
        name="club_my_home",
    ),
    path("my/clubs/", my_clubs, name="my_clubs"),
    ...
    path(
        "my/tournaments/<slug:tournament_slug>/cancel/",
        my_tournament_cancel,
        name="my_tournament_cancel",
    ),
    ...
    path(
        "my/plan/auto-renew/enable/",
        my_plan_enable_auto_renew,
        name="my_plan_enable_auto_renew",
    ),
    path(
    ...
    path(
        "<slug:slug>/dashboard/plans/toggle/",
        plan_toggle_usage,
        name="plan_toggle_usage",
    ),
    ...
    path(
        "<slug:slug>/invite/import-template/",
        invite_import_template,
        name="invite_import_template",
    ),
    path("<slug:slug>/members/", members_list, name="members_list"),
    path("<slug:slug>/balances/", balances_list, name="balances_list"),
    path(
        "<slug:slug>/balances/<int:member_id>/",
        balance_detail,
        name="balance_detail",
    ),
    path(
    ...
    path(
        "<slug:slug>/payments/history/",
        club_cashbox_history,
        name="club_cashbox_history",
    ),
    path(
    ...
    path(
        "<slug:slug>/invites/<int:pk>/activate/",
        invite_activate,
        name="invite_activate",
    ),
    path(
        "<slug:slug>/invites/<int:pk>/delete/",
        invite_delete,
        name="invite_delete",
    ),
