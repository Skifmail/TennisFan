            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=200,
                        verbose_name="Заголовок блока «Прямые трансляции»",
                    ),
                ),
                (
                    "playlist_title",
                    models.CharField(
                        default="Плейлист",
                        max_length=200,
                        verbose_name="Заголовок блока «Плейлист»",
                    ),
                ),
                (
                    "updated_at",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        max_length=200, verbose_name="Название трансляции"
                    ),
                ),
                (
                    "url",
                    models.URLField(
                        help_text="Ссылка на прямую трансляцию YouTube, VK или RuTube",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "url",
                    models.URLField(
                        help_text="Ссылка на видео YouTube, VK или RuTube",
                ...
                (
                    ...
                    models.URLField(
                        ...
                        verbose_name="URL превью (опционально)",
                    ),
                ),
                (
                    "is_published",
