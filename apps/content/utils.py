...
def extract_vk_video_id(url: str) -> Optional[tuple[str, str]]:
    """
...
def extract_rutube_video_id(url: str) -> Optional[str]:
...
def get_video_embed_url(url: str, platform: str) -> Optional[str]:
    """
