...
# ---------------------------------------------------------------------------
# Районы Москвы и города области (редактируются в админке)
# ---------------------------------------------------------------------------


class GeoArea(models.Model):
    """Площадка проведения внутри региона: район Москвы или город области.
    ...
    aliases = models.TextField(
        ...
        default="",
        help_text=(
            "По одному в строке. Используются для распознавания района "
    ...
    def resolve_from_name(
        ...
        Нужна для разбора уже созданных турниров: район указан только внутри
        названия, например «Турнир TennisFan Юг».
        ...
        # Сначала длинные псевдонимы: «Юго-Восток» не должен проиграть «Юг».
        candidates = [
