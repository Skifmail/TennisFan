    ...
    def meta_description(self) -> str:
        ...
        if not self.is_filtered:
            return (
                ...
                "Набор по уровню. Место проведения появится после набора."
            )
        return (
            f"{self.heading}. Набор по уровню, старт после набора группы. "
            "Время и корт матчей договариваетесь с соперником."
        )
