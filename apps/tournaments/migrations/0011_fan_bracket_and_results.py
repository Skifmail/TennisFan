    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.BooleanField(
                default=False, verbose_name="Подвал (матч вылетевших)"
            ),
        ),
        migrations.AddField(
            model_name="match",
        ...
        migrations.AddField(
            ...
            field=models.PositiveSmallIntegerField(
                ...
                verbose_name="Порядок матча в раунде",
            ),
        ),
        migrations.AddField(
            ...
            field=models.BooleanField(
                ...
                verbose_name="Сетка сформирована",
            ),
        ),
        migrations.AddField(
            model_name="tournament",
            ...
            field=models.PositiveSmallIntegerField(
                default=70, verbose_name="FAN: очки финалисту"
            ),
        ),
        migrations.AddField(
            model_name="tournament",
            name="fan_points_r1",
            field=models.PositiveSmallIntegerField(
                default=10, verbose_name="FAN: очки за 1 круг"
            ),
        ),
        migrations.AddField(
            model_name="tournament",
            name="fan_points_r2",
            field=models.PositiveSmallIntegerField(
                default=25, verbose_name="FAN: очки за 2 круг"
            ),
        ),
        migrations.AddField(
            model_name="tournament",
            name="fan_points_sf",
            field=models.PositiveSmallIntegerField(
                default=45, verbose_name="FAN: очки за полуфинал"
            ),
        ),
        migrations.AddField(
            model_name="tournament",
            ...
            field=models.PositiveSmallIntegerField(
                default=100, verbose_name="FAN: очки победителю"
            ),
        ),
        migrations.AddField(
            model_name="tournament",
        ...
        migrations.AddField(
            ...
            field=models.PositiveSmallIntegerField(
                ...
                verbose_name="Дней на раунд (дедлайн матча)",
            ),
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=0, verbose_name="Начислено очков FAN"
                    ),
                ),
                (
                    "is_consolation",
                    models.BooleanField(default=False, verbose_name="Вылет в подвале"),
                ),
                (
                    "player",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="tournament_fan_results",
                        to="users.player",
                    ),
                ),
                (
